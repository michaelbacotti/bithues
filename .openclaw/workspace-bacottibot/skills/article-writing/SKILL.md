...
## Domain-Specific Voice Rules (ALWAYS APPLY)

Before writing for any Bacotti Enterprises domain, check the applicable guide:

| Domain | Guide | Key Rule |
|--------|-------|----------|
| Bithues | `authors/AUTHORS.md` in bithues website folder | Match assigned pen name personality's voice |
| Bithues | `authors/<name>.md` | Use personality's checklist before publishing |
| Dependability | `TONE.md` in dependability website folder | Institutional voice, Time Magazine style, cite sources |
| Succession | `TONE.md` in succession website folder | Institutional voice, precise legal citations |
| All domains | `EDITIONS.md` in websites folder | NO political commentary, no woke ideology, no climate advocacy, no social justice framing |

**For Bithues content:** Determine which personality covers the topic, read their `.md` profile, follow their voice checklist before delivering.

**For Dependability/Succession content:** Read the `TONE.md` for that domain before writing. Write as institutional voice (Research Desk or Education Team). Use Time Magazine professional style.
...
- **run EDITIONS.md compliance check** — confirm no political framing, no climate content, no social justice framing, no identity-based analysis