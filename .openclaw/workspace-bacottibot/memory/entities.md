...
> **Source: Tax Files are final authority.** When tax files contradict any other document, trust the tax file.
...
| **Bacotti Inc.** | Family office — manages all entities, owns 20% of Dependability, responsible for all meeting minutes |
| **HOUSE Inc.** | Nonprofit, 501c3 |

**⚠️ All stock/options/trading matters** → Tag to Dependability Holding

**⚠️ Meeting minutes** → Bacotti Inc. is responsible for all meeting minutes. See `memory/Bacotti Inc.md` for filing locations.
