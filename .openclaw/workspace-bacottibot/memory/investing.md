# Investing — Dependability Trading & Options

## ⚠️ All stock/options/trading matters → Dependability Holding LLC
...
## Market Event: April 2, 2026 Selloff

- S&P 500: ~6,508 (-1.1% on the day)
- VIX: 25.57 (+4.2%) — elevated, institutional hedging active
- Oil: WIX $111.92 (+11.7%), Brent $109.10 (+7.8%) — Strait of Hormuz disrupted
- Cause: Iran war escalation
- XSP support: 650 (critical) → 640 → 635
...
|-------|---------|----------|
| **Options Pro** | Stock/options analysis, Greeks, spread strategies | `skills/options-pro/` |
| **Stock Market Pro** | Stock market analysis | `skills/stock-market-pro/` |
